  ...
  return (
    <div className="temp-content">
      <div className="Header-part">
        ...
        <div className="header-name text-end ">
        ...
        <tbody>
          <tr>
            <td className="col-1" valign="top">
              ...
              <div className="item">
                <h2 className="side-title h2-color">Personal Details</h2>
                ...
                {skills.map((item, index) => (
                  <div key={index} className="temp-item ">
                    <div className="temp-item-head skill-s">
                      ...
                      <div className="side-item-rating lang-star"></div>
                    </div>
                  </div>
                ))}
              </div>
